...
const mojeinfo: InfoType[] = [
  {
    ...
    imgSrc: "./assets/cosplay/pictures/xayah-pic-1.jpg",
    visualInfluence: [
      "./assets/cosplay/pictures/xayah-ref-1.jpg",
      "./assets/cosplay/pictures/xayah-ref-2.jpg",
    ],
  ...
  },
  {
    ...
    imgSrc: "./assets/cosplay/pictures/hiryuu-pic-1.jpg",
    visualInfluence: [
      "./assets/cosplay/pictures/hiryuu-ref-1.jpg",
      "./assets/cosplay/pictures/hiryuu-ref-2.jpg",
    ],
  ...
  },
  {
    ...
    techniques: "Sewing, foam carving, airbrush painting",
    imgSrc: "./assets/cosplay/pictures/sivir-pic-1.jpg",
    visualInfluence: [
      "./assets/cosplay/pictures/sivir-ref-1.jpg",
      "./assets/cosplay/pictures/sivir-ref-2.jpg",
    ],
    buttons: ["Mask", "Weapon"],
  },
  {
    ...
    imgSrc: "./assets/cosplay/pictures/richelieu-pic-1.jpg",
    visualInfluence: [
      "./assets/cosplay/pictures/richelieu-ref-1.jpg",
      "./assets/cosplay/pictures/richelieu-ref-2.jpg",
    ],
    buttons: ["Wig", "Flag"],
  },
  {
    ...
    imgSrc: "./assets/cosplay/pictures/pestonya-pic-1.jpg",
    visualInfluence: [
      "./assets/cosplay/pictures/pestonya-ref-1.jpg",
      "./assets/cosplay/pictures/pestonya-ref-2.jpg",
    ],
