...
const Section1 = () => {
  return (
    <div className="w-full h-svh flex flex-row justify-center items-center font-heading font-size-3xl overflow-hidden relative">
      <Image
        src="./assets/cosplay/background/bg-image.jpg"
        width={1730}
        height={1177}
        alt=""
        ...
        <div className="w-full px-10 h-full flex flex-col items-center justify-center bg-background/75 z-10 gap-10">
          ...
          <div className="text-center px-10 ">
            ...
            <h2 className="text-txt text-2xl -mt-8 font-[inknutAntiqua]">
              ...
              basics of pattern making and XPS foam shapeing from the internet.
              Her first costume, made in 4th grade of primary school, was of
              Morgana from League of Legends, created from old clothes and crepe
              paper.
              <br />
